...
$restorations = array(
    ...
    "PalmCast (Restored)" => (array) [
        'author' => "Mobile Nations",
        'link' => "http://webosarchive.org",
        'episodeCount' => 97,
        'title' => "PalmCast (Restored)",
        'url' => "http://www.webosarchive.org/podcasts/feeds/PalmCast/feed.xml",
        'image' => "https://www.webosarchive.org/podcasts/feeds/PalmCast/PalmCast.jpg",
        'description' => "Derek Kessler and team discuss the latest HP mobile news, offer webOS tips, and chime in with the PreCentral Community'",
        'substitution_reason' => "This feed and its content links were restored from a Wayback Machine archive and hosted by the webOS Archive community. Some episodes are missing."
    ],
);
?>
